...
export default function Home() {
  ...
  const FEATURES = [
    {
      icon: "🔍",
      titleKey: "home.feat_realtime_title",
      descKey: "home.feat_realtime_desc",
    },
    {
      icon: "📊",
      titleKey: "home.feat_dashboard_title",
      descKey: "home.feat_dashboard_desc",
    },
    {
      icon: "🎓",
      titleKey: "home.feat_youth_title",
      descKey: "home.feat_youth_desc",
    },
    {
      icon: "🤝",
      titleKey: "home.feat_ngo_title",
      descKey: "home.feat_ngo_desc",
    },
    {
      icon: "🌐",
      titleKey: "home.feat_multi_title",
      descKey: "home.feat_multi_desc",
    },
    {
      icon: "♿",
      titleKey: "home.feat_a11y_title",
      descKey: "home.feat_a11y_desc",
    },
  ];
  ...
  const HERO_ITEMS = [
    {
      icon: "🎣",
      labelKey: "home.hero_item_phishing",
      statusKey: "home.hero_status_detected",
    },
    {
      icon: "💰",
      labelKey: "home.hero_item_investment",
      statusKey: "home.hero_status_high_risk",
      highlight: true,
    },
    {
      icon: "📣",
      labelKey: "home.hero_item_radicalization",
      statusKey: "home.hero_status_monitoring",
    },
    {
      icon: "💸",
      labelKey: "home.hero_item_money_laundering",
      statusKey: "home.hero_status_flagged",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800 text-white overflow-hidden">
        <div
          className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-accent-400 via-transparent to-transparent"
          aria-hidden="true"
        />
              ...
              {HERO_ITEMS.map((item) => (
                <div
                  ...
                  className={`flex items-center gap-3 rounded-xl p-3 ${
                    item.highlight
                      ? "bg-danger-500/30 border border-danger-400/40"
                      : "bg-white/5"
                  }`}
                >
      ...
      {/* ── Impact stats strip ─────────────────────────────────────────────── */}
      <section
        className="bg-primary-700 text-white py-10"
        aria-label={t("home.impact_aria_label")}
      >
